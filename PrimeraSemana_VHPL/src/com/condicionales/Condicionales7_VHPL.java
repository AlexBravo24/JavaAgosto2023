...
public class Condicionales7_VHPL {
	...
	public static void main(String[] args) {
		...
		// de 65 euros. * De 50 a 99 alumnos, el costo es de 70 euros. * De 30 a 49 alumnos, el costo es 
		// de 95 euros. * Menos de 30 alumnos, el costo de la renta del autobús es de 4000 euros, sin 
		// importar el número de alumnos. Realiza un algoritmo que permita determinar el pago a la compañía
